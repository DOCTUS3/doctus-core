...
case object DoctusColorBlack extends DoctusColor {
  ...
  def apply: DoctusColorRgb = DoctusColorRgb(colors._1, colors._2, colors._3)
  def rgb: (Int, Int, Int) = colors
}
...
/** The color magenta
  */
case object DoctusColorMagenta extends DoctusColor {
...
case class DoctusColorRgb(red: Int, green: Int, blue: Int) extends DoctusColor {
  def rgb: (Int, Int, Int) = (red, green, blue)
}
